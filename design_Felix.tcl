...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
DigiLAB:ip:AXI4Stream_FT245Sync:1.4\
DigiLAB:ip:BeltBus_TDCLedCounter:2.0\
...
DigiLAB:ip:dlconstant_gpio:1.1\
...
DigiLAB:hier:BeltBus_TDL_Channel_TDC:3.5\
DigiLAB:ip:InputLogic:3.2\
